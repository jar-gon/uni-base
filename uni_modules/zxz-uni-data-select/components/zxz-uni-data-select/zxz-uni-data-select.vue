    ...
    <view class="uni-stat-box" :class="{ 'uni-stat__actived': current }">
      ...
      >
        ...
        <view
          ...
          :class="isDown ? 'uni-select__selector__down' : 'uni-select__selector__upwards'"
          v-if="showSelector"
        >
          ...
          <scroll-view scroll-y="true" class="uni-select__selector-scroll">
            ...
            <view
              ...
              :class="[
                ...
                { 'uni-select_selector-item_active': multiple && currentArr.includes(item[dataValue]) },
              ]"
    ...
    if (this.multiple) {
      ...
      if (this.modelValue || this.value == 0) {
        this.current = this.formatItemName(
          this.filterMixinDatacomResData.find(e => e[this.dataValue] == this.modelValue)
        );
      }
      // #endif
    }
